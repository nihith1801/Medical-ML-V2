...
export default function XRayPage() {
  ...
  const handleUpload = async () => {
    if (file) {
      setIsLoading(true)
      try {
        const result = await getPrediction(file, ModelType.BONE_FRACTURE)
    ...
    <ClientWrapper>
      <div className={cn(
        ...
        <div className="container mx-auto px-4 py-8 flex flex-col items-center justify-center">
          ...
          >
            Our advanced X-Ray Analysis model utilizes deep learning techniques to analyze X-ray images,
            helping detect various abnormalities including bone fractures. It provides rapid and accurate insights
          ...
          {(preview || prediction) && (
            <ImagePreview
              ...
              modelType={ModelType.BONE_FRACTURE}
              isLoading={isLoading}
            />
          )}
        </div>
