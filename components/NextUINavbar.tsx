    ...
    <nav className={cn(
      ...
      <div className="flex items-center space-x-12">
        <Link href="/" className="flex items-center space-x-2">
          <svg className={cn("w-8 h-8", currentTheme === 'dark' ? "text-white" : "text-black")} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className={cn("text-xl font-bold", currentTheme === 'dark' ? "text-white" : "text-black")}>Medical ML</span>
        </Link>
          ...
          {menuItems.map((item) => (
            <Link
              ...
              className={cn(
                ...
                currentTheme === 'dark' ? "text-white hover:text-gray-300" : "text-black hover:text-gray-600"
              )}
            >
              {item.name}
            </Link>
      ...
      <div className="flex items-center space-x-6">
        <Around 
          ...
          onToggle={() => setTheme(currentTheme === 'dark' ? 'light' : 'dark')}
        />
